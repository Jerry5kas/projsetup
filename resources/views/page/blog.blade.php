<x-layouts.app header="Blog">
    <div class="h-screen border shadow-md bg-black/60 flex justify-center items-center font-lex">
        <div class="space-y-5 text-center ">
            <div class="text-gray-100 font-merri text-xl ">Create a New Post</div>
            <form action="/blog" method="POST" class="w-96 mx-auto flex flex-col gap-y-5 border rounded  p-5 py-10 bg-white">
                @csrf
